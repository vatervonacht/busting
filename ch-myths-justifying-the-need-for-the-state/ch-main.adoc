...
include::s-acquiescence-to-the-state.adoc[]

include::myth-the-state-is-an-improvement-on-the-free-market.adoc[]

include::myth-we-need-the-state-to-provide-public-goods.adoc[]

include::myth-we-need-the-state-to-deal-with-negative-externalities.adoc[]

include::myth-we-need-the-state-to-deal-with-anti-competitive-behavior.adoc[]

include::myth-the-hobbesian-fear.adoc[]
